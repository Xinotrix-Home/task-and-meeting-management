...
const TASK_TYPES = ["In-Person", "Online", "Hybrid"];
const TASK_STATUSES = ["Scheduled", "Completed", "Cancelled"];

export default function TaskHeaderFilters({
  filterMenuButton,
  // isMobile,
  classname = "",
  filterClassname = "",
      ...
      <div className={cn(filterClassname)}>
        ...
        >
          <div className="space-y-4 p-2 w-64 text-sm text-custom-text-100">
            {/* Task Type Filter */}
            <div>
              <p className="mb-1 font-medium">Task Type</p>
